                            ...
                            HStack(spacing: 16) {
                                ForEach(films.prefix(10)) { film in
                                    NavigationLink(destination: MovieDetailView3(film: film)) {
                                        ...
                                        // Agrupamos imagen y texto en un único elemento accesible
                                        .accessibilityElement(children: .ignore)
                                        .accessibilityLabel("\(film.title), tap to view details")
                                    }
                                }
                            }
                            .padding(.horizontal)
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        Button {
                            ...
                            Image(systemName: "plus")
                                .font(.title2)
                                .padding()
                                .accessibilityLabel("Add a new film")
                        }
